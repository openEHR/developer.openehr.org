...
These are the places where archetypes and templates are stored, governed, and shared.

## Clinical Knowledge Manager (CKM) - international instance
...
**CKM instances:** Many national programmes run their own CKM instances on the same Ocean Health Systems software. These include UK, Norwegian, Australian, Slovenian, and Catalan instances.

## CKM Rocks (Ocean Health Systems)
