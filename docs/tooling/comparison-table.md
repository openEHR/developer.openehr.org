...
| LinkEHR Studio | Multi-model editing and data mapping | Commercial | No | Windows | Active |
...
| openFHIR | Bidirectional openEHR/FHIR mapping engine | Free (Enterprise commercial) | Yes | Java | Active |
